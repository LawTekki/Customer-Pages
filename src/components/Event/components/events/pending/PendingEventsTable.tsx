...
const pendingEvents = [
  {
    ...
    fee: '$199',
    time: '9am - 5pm',
    attendees: { count: 45, images: ['/Frame 1000008098 (1).jpg'] },
    status: 'Pending',
  },
  {
    id: 2,
    ...
    fee: '$149',
    time: '2pm - 6pm',
    attendees: { count: 75, images: ['/Frame 1000008098 (1).jpg'] },
    status: 'Pending',
  },
  {
    id: 3,
    title: 'Legal Drafting Bootcamp',
    host: { name: 'Chris Evans', image: '/Frame 1000008098 (1).jpg' },
  ...
  {
    id: 4,
    title: 'Legal Research Seminar',
    host: { name: 'Olivia King', image: '/Frame 1000008098 (1).jpg' },
  ...
  {
    id: 5,
    title: 'Legal Ethics Panel',
    host: { name: 'Sophia Turner', image: '/Frame 1000008098 (1).jpg' },
    date: 'September 20, 2024',
    eventType: 'Hybrid',
    venue: 'Main Hall',
    fee: '$150',
    time: '1pm - 4pm',
    attendees: { count: 55, images: ['/Frame 1000008098 (1).jpg'] },
    status: 'Pending',
  },
];
...
const PendingEventsTable = () => {
  ...
  const totalPages = Math.ceil(pendingEvents.length / ROWS_PER_PAGE);
  const startIdx = (currentPage - 1) * ROWS_PER_PAGE;
  const currentEvents = pendingEvents.slice(startIdx, startIdx + ROWS_PER_PAGE);

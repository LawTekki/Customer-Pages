...
export const Pagination: React.FC<PaginationProps> = ({
    ...
    for (let i = 1; i <= totalPages; i++) {
      if (
        ...
        pages.push(
          <div
            key={i}
            className="w-9 h-9 text-[#808080] text-sm font-normal leading-5 bg-white rounded-md border border-[#E6E6E6] flex items-center justify-center fade-in"
  ...
  return (
    <div className="flex justify-center items-center gap-2 mt-5 fade-in" style={{ animationDelay: '0.5s', overflow: 'hidden' }}>
      <button

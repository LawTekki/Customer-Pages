    ...
    <form onSubmit={handleSubmit} className="grow font-medium leading-[1.3]">
      <div className="flex w-full flex-col items-stretch">
        <div className="flex items-center gap-[13px] mb-4">
          <label htmlFor="profile-photo" className="cursor-pointer flex items-center gap-3">
            <img
              ...
              alt="Profile"
              className="aspect-[1] object-contain w-[120px] self-stretch shrink-0 my-auto rounded-full border"
            />
        ...
        <div className="flex w-full gap-4 text-sm flex-wrap mt-4">
          ...
          >
            <select
              className="border border-[color:var(--Grey-1,#F2F2F2)] w-full mt-2 px-2.5 py-4 rounded-lg bg-neutral-50 text-[#666]"
              value={country}
        ...
        >
          <input
            type="tel"
            className="text-[#666] self-stretch border border-[color:var(--Grey-1,#F2F2F2)] w-full mt-2 px-2.5 py-4 rounded-lg bg-neutral-50"
            value={phone}

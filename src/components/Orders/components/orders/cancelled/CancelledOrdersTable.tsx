...
export const CancelledOrdersTable: React.FC = () => {
  ...
  const currentOrders = useMemo(() => cancelledOrders.slice(indexOfFirstOrder, indexOfLastOrder), [currentPage]);
        ...
        <tbody>
          {currentOrders.map((order, index) => (
            <tr key={order.id} className="border-b border-[#F2F2F2] table-row-hover click-shrink fade-in">
              ...
              <td className="p-4">
                      <button
                        className="text-[#808080] border border-[#E6E6E6] px-4 py-1.5 rounded-lg text-sm font-medium w-20 hover-scale click-bounce button-pulse transition-all duration-300"
                        onClick={() => {
            ...
            {currentOrders.map((order, idx) => (
              ...
              >
                ...
                <div className="flex justify-end">
                  <button className={`border px-4 py-1.5 rounded-md text-xs font-medium w-20 hover-scale click-bounce button-pulse transition-all duration-300 text-[#808080] border-[#E6E6E6]`} 
                    onClick={() => {
                      setSelectedOrder(order);
                      setDialogOpen(true);
                    }}

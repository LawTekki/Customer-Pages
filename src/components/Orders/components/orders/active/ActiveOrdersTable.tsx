...
// Mock data for active orders (5 rows as in the screenshot)
...
export const ActiveOrdersTable: React.FC = () => {
  ...
  // Pagination logic (for future scalability)
  const indexOfLastOrder = currentPage * ordersPerPage;
  const indexOfFirstOrder = indexOfLastOrder - ordersPerPage;
  const currentOrders = useMemo(() => activeOrders.slice(indexOfFirstOrder, indexOfLastOrder), [currentPage]);

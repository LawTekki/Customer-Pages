      ...
      <div className="flex items-center text-xs text-[#808080] font-medium tracking-[-0.24px] leading-[1.3] flex-wrap">
        <div className="w-full">
          ...
          <div className="overflow-hidden max-w-full">
            <table className="max-md:hidden table-fixed w-full">
              <thead>
                <tr className="border-b border-[#E6E6E6] bg-neutral-50 text-[#1A011E]">
                  <th className="px-[7px] py-5 text-left w-[4%] hover:bg-gray-100 transition-colors">S/N</th>
                  <th className="px-6 py-5 text-left w-[18%] hover:bg-gray-100 transition-colors">Title</th>
                  <th className="px-[19px] py-5 text-left w-[14%] hover:bg-gray-100 transition-colors">Completed deals</th>
                  <th className="px-6 py-5 text-left w-[14%] hover:bg-gray-100 transition-colors">Amount spent</th>
                  <th className="px-6 py-5 text-left w-[22%] hover:bg-gray-100 transition-colors">Last deal date</th>
                  <th className="px-[23px] py-5 text-left w-[18%] hover:bg-gray-100 transition-colors">Action</th>
                </tr>
              </thead>
              <tbody>
                {currentContacts.map((contact, index) => (

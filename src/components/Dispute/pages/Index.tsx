...
const Dispute = () => {
  return (
    <div className="bg-white min-h-screen overflow-hidden">
      <Header />
      <div className="flex w-full max-w-[1350px] mx-auto items-stretch gap-8 max-md:flex-col">
        <Sidebar />
        <main
          className="grow shrink basis-auto my-auto max-md:max-w-full mt-8 max-md:mt-0 max-md:px-0 pr-8"
          role="main"
        >
          <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
            <div className="w-full max-md:w-full max-md:ml-0">
              <div className="w-full max-md:max-w-full max-md:mt-0">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 mt-2 gap-2 md:gap-0">
                  ...
                  <button 
                    className="bg-[#6B047C] hover:bg-[#4A0356] text-white font-medium rounded-lg px-6 py-3 text-sm mt-2 md:mt-0 shadow-sm transition-all duration-300 hover:scale-105 hover:shadow-md fade-in hover-lift" 

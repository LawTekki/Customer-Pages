    ...
    <FilterProvider>
      <div className="bg-white w-full overflow-hidden max-md:max-w-full">
        ...
        <div className="flex w-full items-stretch gap-[31px] max-md:max-w-full">
          ...
          <div className="flex mt-8 border border-gray-100 rounded-lg max-md:flex-col max-md:border-0 max-md:gap-2 w-full bg-white fade-in" style={{ animationDelay: '0.2s' }}>

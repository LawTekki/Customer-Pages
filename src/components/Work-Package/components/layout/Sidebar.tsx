  ...
  return (
    <nav className="border-r-[color:var(--Grey-2,#E6E6E6)] bg-white flex flex-col overflow-hidden text-xs font-medium tracking-[-0.24px] leading-[1.3] pt-10 pb-[197px] px-[22px] rounded-[8px_0px_0px_0px] border-r border-solid max-md:pl-5 max-md:pb-[100px]">
      <div className="flex flex-col items-center">
        ...
        />
        <div
          className="flex flex-col items-center whitespace-nowrap mt-8 text-[#808080] cursor-pointer"
          onClick={() => setShowProfileDropdown(prev => !prev)}
        >
          <img
            src="https://cdn.builder.io/api/v1/image/assets/6d6775384ccd46a982a7cf80d05dc013/4f3cec023b05aa08f18e4a6644717c72a7ecb014?placeholderIfAbsent=true"
